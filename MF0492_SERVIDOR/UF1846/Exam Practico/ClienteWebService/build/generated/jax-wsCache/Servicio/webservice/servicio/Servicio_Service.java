 ...
 * 
 */
@WebServiceClient(name = "Servicio", targetNamespace = "http://servicio.webservice/", wsdlLocation = "http://localhost:8080/WebService/Servicio?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIO_QNAME = new QName("http://servicio.webservice/", "Servicio");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebService/Servicio?wsdl");
    ...
    public Servicio getServicioPort() {
        return super.getPort(new QName("http://servicio.webservice/", "ServicioPort"), Servicio.class);
    }
    ...
    public Servicio getServicioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio.webservice/", "ServicioPort"), Servicio.class, features);
    }
